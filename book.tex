...
\chapter{Case study: Searching for Information}

In this chapter, we will bring several chapters together 
to write some simple programs that scna data stored in files, 
looking for various bits of information.

% TBD - Goal is to motivte functions by getting larger and larger
