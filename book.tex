...
A non-greedy match tried to find the smallest possible matching
...
\section{Reading non-text files}
...
bult into your operating system that performs this operation
as follows:
\index{curl}
...
actually want to use this to retrieve binary files directly to your
hard drive across the web.
