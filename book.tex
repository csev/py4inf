...
must {\tt open} the file.  Opening the file communicates with your operating
...
%
\index{file handle}
If the {\tt open} is successful, the operating system gives a 
...
the newline character.  Python reads line through the newline and includes
...
20 characters of the dstring data stored in {\tt inp}.

When the file is read in this manner, all the characters including 
all of the newlines are in the variable {\bf inp}.  Remember
that this form of the {\tt open} function should only be used
