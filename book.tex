...
Support for searching files using regular expressions was built into the UNIX operating systemm since the 1960's and it is available in nearly all programming languages in one form or another.
