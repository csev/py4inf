...
server, we make a connection to the {\tt data.pr4e.org} server on port 80, and then
send a line of the form

{\tt GET http://data.pr4e.org/romeo.txt HTTP/1.0 }
...
\beforeverb
\begin{verbatim}
curl -O http://data.pr4e.org/cover.jpg
\end{verbatim}
\afterverb
%
