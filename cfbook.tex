...
to manage and visualize data.  These applications might 
be sample code that might help get you started in solving your
real-world problems.
...
map.  To get started, download the application from:

\url{www.py4inf.com/code/geodata.zip}

When you finish, you will have a google map that gives
you the locations from your survey data:

\beforefig
\centerline{\includegraphics[height=2.50in]{figs2/google-map.eps}}
\afterfig
...
geocoded response and store it in a database {\bf geodata.sqlite}.
...
Retrieving http://maps.googleapis.com/maps/api/
    geocode/json?sensor=false&address=Kokshetau+Institute+of+Economics+and+Management
...
program reads the database and writes tile file {\bf where.js}
...
\begin{verbatim}
myData = [
[42.3396998,-71.08975, 'Northeastern University, 360 ... Boston, MA 02115, USA'],
