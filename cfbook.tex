...
\afterverb
%
Our database is stored in the file {\tt spider.db} and it has one 
...
is empty and we create the database in the file {\tt spider.db} and
...
to take a look at what is in our {\tt spider.db} file:
