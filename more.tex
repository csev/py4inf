...
\section{SQLite2 Database Browser}

While this chapter will focus on using Python to work with data 
in SQLite3 database files, many operations can be done more
convienently using a desktop program called the {\bf SQLite3
...
or dictionaries\footnote{SQLite3 actualy does allow some 
...
you can look at the various data types supported by SQLite3
...
the FireFox browser also uses the SQLite database internally as to 
many other products.
