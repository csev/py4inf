...
account name or press enter or enter to ``quit'' to exit the program.  
...
relationship between the two tables is called {\bf data modeling}.  The
...
row.   SQLite has a feature that automatically adds the key value
...
In this chapter, we use an optional
...
\item[database normalization:] Def
\index{database normalization}

\item[primary key:] Def
\index{primary key}
